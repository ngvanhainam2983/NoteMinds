  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-2xl border border-slate-700/50 p-6">
              ...
              {stats.byType && stats.byType.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-400">No email data available yet</div>
              )}
            </div>
          </div>
        )}

        {activeTab === 'overview' && (!stats || !stats.overview) && !loading && (
          <div className="bg-slate-800/50 backdrop-blur rounded-2xl border border-slate-700/50 p-12 text-center">
            <div className="text-gray-400 mb-2">No email statistics available</div>
            <p className="text-sm text-gray-500">Send some emails to see tracking data here</p>
          </div>
        )}

        {activeTab === 'recent' && stats && stats.recent && stats.recent.length > 0 && (
        ...
        {activeTab === 'recent' && (!stats || !stats.recent || stats.recent.length === 0) && !loading && (
          <div className="bg-slate-800/50 backdrop-blur rounded-2xl border border-slate-700/50 p-12 text-center">
            <div className="text-gray-400 mb-2">No recent emails</div>
            <p className="text-sm text-gray-500">Recent emails will appear here once you start sending</p>
          </div>
        )}
        ...
        {activeTab === 'daterange' && (
          <div>
            ...
            {rangeStats && rangeStats.overview && (
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/10 border border-purple-500/30 rounded-2xl p-6">
                    <div className="text-purple-400 text-sm font-medium mb-2">Total Sent</div>
                ...
                <div className="bg-slate-800/50 backdrop-blur rounded-2xl border border-slate-700/50 p-6 mb-6">
                  ...
                  {rangeStats.daily && rangeStats.daily.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-gray-400">No data for this date range</div>
                  )}
                </div>

                <div className="bg-slate-800/50 backdrop-blur rounded-2xl border border-slate-700/50 p-6">
                  <h2 className="text-xl font-bold mb-4">Performance by Type</h2>
                  {rangeStats.byType && rangeStats.byType.length > 0 ? (
                    <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="text-center py-8 text-gray-400">No email type data for this range</div>
                  )}
                </div>
              </div>
            )}
